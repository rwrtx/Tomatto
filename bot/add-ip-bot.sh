#!/bin/bash
# // PROJECT STORE
url_izin="https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin"
...
cd /root/ipvps
git config --global user.email "rwrtx87@gmail.com" &> /dev/null
git config --global user.name "rwrtx" &> /dev/null
rm -rf .git &> /dev/null
git init &> /dev/null
git add . &> /dev/null
...
git push -f https://${TOKEN}@github.com/rwrtx/vvipsc.git &> /dev/null
rm -rf /root/ipvps
clear
