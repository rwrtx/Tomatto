...
IPVPS=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
#botwa
...
#mkdir /root/casper
#cd /root/casper
#wget https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin >/dev/null 2>&1
...
#key2
#fi
#LIST=$(curl -sS https://raw.githubusercontent.com/rwrtx/license/main/key | grep $kode | awk '{print $2}')
#$Key=$(curl -sS https://raw.githubusercontent.com/rwrtx/license/main/key | grep $kode | awk '{print $3}')
#KEY2=$(curl -sS https://raw.githubusercontent.com/rwrtx/license/main/key | grep $kode | awk '{print $4}')
#ADMIN=$(curl -sS https://raw.githubusercontent.com/rwrtx/license/main/key | grep $kode | awk '{print $5}')
#TOTALIP=$(curl -sS https://raw.githubusercontent.com/rwrtx/license/main/key | grep $kode | awk '{print $6}')
#cd
...
#sleep 0.5
#rm ipmini
#wget https://raw.githubusercontent.com/rwrtx/license/main/key >/dev/null 2>&1
#if [ "$ADMIN" = "ON" ]; then
...
res1() {
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
clear
echo -e  "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e  "${BIBlue}│  \033[1;37m xxxx.r32wrtxtunneling.site        ${BIBlue}│${NC}"
...
clear
echo -e  "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e  "${BIBlue}│  \033[1;37m  xxxx.vpscloud.web.id         ${BIBlue}│${NC}"
echo -e  "${BIBlue}│    \033[1;37mxxxx jadi subdomain nama kamu               ${BIBlue}│${NC}"
echo -e  "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo " "
...
clear
echo -e  "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e  "${BIBlue}│  \033[1;37m xxxx.vpsstore-r32wrt.xyz       ${BIBlue}│${NC}"
...
#apt install npm -y
#npm install express
#wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/install/ins-botwa.sh && chmod +x ins-botwa.sh && ./ins-botwa.sh
#cd
#clear
#}
function Casper2(){
...
clear
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear

echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}       PROCESS INSTALLED XRAY           ${NC}${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear

echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}      PROCESS INSTALLED WEBSOCKET SSH   ${NC}${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear

echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}      PROCESS INSTALLED BACKUP MENU     ${NC}${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear

#echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
#echo -e "${BIBlue}│ ${BGCOLOR}          PROCESS INSTALLED OHP         ${NC}${BIBlue} │${NC}"
#echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
#wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#clear

echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}          DOWNLOAD EXTRA MENU           ${NC}${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear

#echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
#echo -e "${BIBlue}│ ${BGCOLOR}           DOWNLOAD SLOW DNS            ${NC}${BIBlue} │${NC}"
#echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
#wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
#clear
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear

echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}    PROCESS INSTALLED NOOBZVPNS         ${NC}${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/noobz/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
#wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/bin/limit.sh && chmod +x limit.sh && ./limit.sh
clear

echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}    PROCESS INSTALLED TROJAN-GO         ${NC}${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
#wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/install/ins-trgo.sh && chmod +x ins-trgo.sh && ./ins-trgo.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
<code>━━━━━━━━━━━━━━━━━━━━</code>
<i>  AutoScript By TomattoVPN</i>
<code>━━━━━━━━━━━━━━━━━━━━</code>
<i> Notifikasi Installer Script...</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/TomattoVPN wa.me/+6281912345565"},{"text":"GRUP","url":"https://t.me/patunganvps01"}]]}'
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/rwrtx/Tomatto/main/versi  )
