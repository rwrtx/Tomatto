...
Isadmin=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "ON" ]; then
m-ipku.sh
else
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
...
listuser=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $2}')
superadmin=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $7}')
...
rm -rf .git &> /dev/null
git init &> /dev/null
wget https://raw.githubusercontent.com/${USERGIT}/vvipsc/main/izin &> /dev/null
...
git remote add origin https://github.com/${USERGIT}/vvipsc.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/vvipsc.git &> /dev/null
else
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ ${NC}${COLBG1}            ${WH} KAMU BUKAN SUPER ADMIN              ${NC}$COLOR1 │$NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
...
function add_ip(){
clear
nama2=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $2}')
author=$(cat /etc/profil)
TIMES="10"
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/vvipsc/main/izin | awk '{print $4}' | grep $daftar)
...
MYIP=$(curl -sS ipv4.icanhazip.com)
U2=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $6}')
...
nama2=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $2}')
Exp2=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $3}')
job2=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $7}')
ip=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $6}')
...
git commit -m register &> /dev/null
git branch -M main &> /dev/null
git remote add origin https://github.com/${USERGIT}/vvipsc &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/vvipsc &> /dev/null
sleep 0.5
rm ip
...
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/vvipsc/main/izin | grep $iprenew | awk '{print $4}')
...
name1=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/vvipsc/main/izin | grep $iprenew | awk '{print $2}') #name
exp=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/vvipsc/main/izin | grep $iprenew | awk '{print $3}') #exp
ivps1=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/vvipsc/main/izin | grep $iprenew | awk '{print $4}') #ip
trial=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/vvipsc/main/izin | grep $iprenew | awk '{print $5}') #ip 
MYIP=$(curl -sS ipv4.icanhazip.com)
UU2=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $2}')

U2=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIPhttps://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $6}')
