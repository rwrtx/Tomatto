...
Name=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $2}')
...
madmin=$(curl -sS https://raw.githubusercontent.com/rwrtx/vvipsc/main/izin | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
mkdir /etc/github
echo "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" > /etc/github/api
echo "rwrtx87@gmail.com" > /etc/github/email
echo "rwrtx" > /etc/github/username
m-ip
fi
}
...
05 | 5) clear ; m-noobz ;;
06 | 6) clear ; m-trgo ;;
07 | 7) clear ; wget https://raw.githubusercontent.com/rwrtx/Tomatto/main/ex.sh && chmod +x ex.sh && ./ex.sh ;;
08 | 8) clear ; running ;;
