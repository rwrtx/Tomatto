...
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ ${NC}             ${WH} TomattoVPN Tunneling${NC}              $COLOR1│$NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
echo -e ""
exit
fi
...
<b><i>Terima Kasih Sudah Menggunakan Credits By TomattoVPN</i></b>
"
...
<i>Tunggu 5 Menit Untuk Server KeRefresh</i>
<b><i>Terima Kasih Sudah Menggunakan Credits By TomattoVPN</i></b>
"'&reply_markup={"inline_keyboard":[[{"text":"CHANNEL","url":"https://t.me/TomattoVPN"},{"text":"ORDER AUTOSCRIPT","
